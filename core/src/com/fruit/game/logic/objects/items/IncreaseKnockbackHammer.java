...
public class IncreaseKnockbackHammer extends Item {
    ...
    public IncreaseKnockbackHammer(ObjectManager objectManager, float spawnCoordX, float spawnCoordY) {
        ...
        width=32;
        height=32;
        description = "A mighty hammer, your shots will push the foes away and you feel stronger!";
        setSaveInRooms(true);
        setItemType(Item.INCREASED_KNOCKBACK_HAMMER);
        setEntityID(GameObject.ITEM);
        setItemName("Mighty hammer of doom");
    }
    ...
    public void onPickUp(Player player) {
        ...
        player.addPassiveEffect(new IncreaseHealthPoints(player,50));
        killYourself();
